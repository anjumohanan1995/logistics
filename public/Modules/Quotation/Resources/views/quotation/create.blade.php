...
@section('content')
    <div class="row">
        {{ Form::open(['url' => 'quotation', 'class' => 'w-100', 'enctype' => 'multipart/form-data']) }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <select
                                                ...
                                                @if (module_is_active('Pos'))<option value="pos">{{ __('Pos') }}</option>@endif
                                            </select>
                                        </div>
                                        <div class="form-group col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="quotation_template" class="form-label">{{ __('Template') }}</label>
                                        <select class="form-control" name="quotation_template" id="quotation_template">
