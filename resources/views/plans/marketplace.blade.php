                    ...
                    <div class="tab-main-div">
                        <div class="nav-pills">
                            <a class="nav-link  p-2" href="{{ route('active.plans') }}" role="tab"
                                aria-controls="pills-home" aria-selected="true">{{ __('Pre-Packaged Subscription') }}</a>
                        </div>
                        <div class="nav-pills">
                            <a class="nav-link active p-2" href="{{ route('plans.index', ['type' => 'subscription']) }}"
                                ...
                                <div class="card">
                                    <div class="card-body package-card-inner  d-flex align-items-center">
                                        ...
                                        <div class="price text-end">
                                            ...
                                            <h5>{{ SubscriptionDetails()['status'] == true ? SubscriptionDetails()['total_workspace'] . ' ' . __('Workspace') : '' }}
                                            </h5>
                                            <span
                                    ...
                                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-sm-6 product-card ">
                                        <div class="card active_module">
                                            <div class="product-img">
                                                ...
                                                <div class="checkbox-custom">
                                                    <div class="action-btn bg-danger ms-2">
                                                        {{ Form::open(['route' => ['cancel.add.on', \Illuminate\Support\Facades\Crypt::encrypt($purchased->getName())], 'class' => 'm-0']) }}
                                                        @method('GET')
                                                        <a href="#"
                                                            class="mx-3 btn btn-sm  align-items-center bs-pass-para show_confirm"
                                                            data-bs-toggle="tooltip" title=""
                                                            data-bs-original-title="Cancel Add-on" aria-label="Delete"
                                            ...
                                            <div class="product-content">
                                                ...
                                                <div class="price d-flex justify-content-between">
                                                    <ins class="m-price-monthly"><span
                                                            class="currency-type">{{ super_currency_format_with_sym(ModulePriceByName($purchased->getName())['monthly_price']) }}</span>
                                                        <span class="time-lbl text-muted">{{ __('/Month') }}</span></ins>
                                                    <ins class="m-price-yearly d-none"><span
                                                            class="currency-type">{{ super_currency_format_with_sym(ModulePriceByName($purchased->getName())['yearly_price']) }}</span>
                                                        <span class="time-lbl text-muted">{{ __('/Year') }}</span></ins>
                                                </div>
                                                <a href="{{ route('software.details', Module_Alias_Name($purchased->getName())) }}"
                                                    target="_new"
                                                    class="btn  btn-outline-secondary w-100 mt-2">{{ __('View Details') }}</a>
                                            </div>
                                        </div>
                            ...
                            <div class="subscription-summery">
                                <ul class="list-unstyled mb-0">
                                    <li>
                                        <span class="cart-sum-left"> <i
                                                class="ti ti-vector-bezier m-2 ti-20"></i>{{ __('Workspace ') }}:</span>
                                ...
                                <div class="summery-footer">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        <li>
                                            ...
                                            <span class="cart-sum-right"><b class="planpricetext "> <span
                                                        class="final_price">{{ $planprice > 0 ? $planprice . $currancy_symbol : 'Free' }}</span></b></span>
                                        </li>
                                        <li>
                                            <span class="cart-sum-left">
                                            ...
                                            <span class="cart-sum-right"><b
                                                    class="workspacepricetext final_price">{{ '0.00' . $currancy_symbol }}</b></span>
                                        </li>
                                        <li>
                                            <span class="cart-sum-left">
                                            ...
                                            <span class="cart-sum-right"><b
                                                    class="userpricetext final_price">{{ '0.00' . $currancy_symbol }}</b></span>
                                        </li>
                                        <li>
                                            <span class="cart-sum-left">
                                            ...
                                            <span class="cart-sum-right"><b
                                                    class="module_price_text final_price">{{ '0.00' . $currancy_symbol }}</b></span>
                                        </li>
                                    </ul>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="form-group w-100">
                                                    ...
                                                    <input type="text" id="coupon" name="coupon"
                                                        class="form-control coupon" placeholder="Enter Coupon Code">
                                                    <small
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input payment_method"
                                                                    name="payment_method" id="bank-payment"
                                                                    type="radio"
                                    ...
                                    <div
                                        ...
                                        <input type="hidden" name="workspace_module_price_input" value="0"
                                            class="workspace_module_price_input">
