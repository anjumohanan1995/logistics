                            ...
                            <div class="row">
                                    ...
                                    @if (!empty($inspectionRequest->inspector_name) && !empty($inspectionRequest->inspector_email))
                                        <div class="col">
                                            <p class="font-style">
                                                ...
                                                {{ !empty($invoice->customer_id) ? \Modules\VehicleInspectionManagement\Entities\InspectionRequest::inspectionRequestIdFormat($invoice->customer_id,$invoice->created_by, $invoice->workspace) : '' }}<br>
                                            </p>
                                            <p class="font-style">
                                                <strong>{{ __('Billed To') }} :</strong><br>
                                ...
                                @if ($invoice->invoice_module == 'machinerepair' && !empty($invoice->customer_id))
                                    ...
                                    <div class="col">
                                        <p class="font-style">
                                            <strong>{{ __('Request Number') }} :</strong><br>
                                            {{ !empty($invoice->customer_id) ? \Modules\MachineRepairManagement\Entities\MachineRepairRequest::machineRepairNumberFormat($invoice->customer_id,$invoice->created_by, $invoice->workspace) : '' }}<br>
                                        </p>
                                        <p class="font-style">
                                            <strong>{{ __('Billed To') }} :</strong><br>
