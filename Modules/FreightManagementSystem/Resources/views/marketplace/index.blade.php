...
@php
    $path = url("/Modules/FreightManagementSystem/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__('Effortlessly manage freight, monitor metrics, and streamline payments with Dash SaaS Freight Management Integration. Drive efficiency and success in your logistics operations today.')}}</p>
                        <div class="price">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Efficient Freight Management with Dash SaaS')}}</h2>
                        </div>
                        <p>{{ __('Streamline logistics operations, monitor metrics, and simplify payments with Dash SaaS Freight Management Integration. Experience seamless efficiency for your logistics business.') }}
                        </p>
                    </div>
                </div>
            </div>
