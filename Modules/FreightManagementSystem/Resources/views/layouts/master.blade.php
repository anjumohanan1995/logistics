@php
    ...
    \App::setLocale(isset($company_settings['lang']) ? $company_settings['lang'] : (isset($admin_settings['lang']) ? $admin_settings['lang'] : 'en'));
@endphp
<!DOCTYPE html>
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('Modules/FreightManagementSystem/Resources/assets/css/site.css') }}" id="stylesheet">
    <!-- font css -->
...
<body
    class="{{ !empty(company_setting('color', $workspace->created_by, $workspace->id)) ? company_setting('color', $workspace->created_by, $workspace->id) : 'theme-1' }}">
    @yield('content')
