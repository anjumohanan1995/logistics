{{ Form::model($booking_request, ['route' => ['booking-request.store.status', [$booking_request->id,$status]], 'method' => 'PUT']) }}
<div class="modal-body">
    <div class="row">
        <div class="form-group col-12">
            {{ Form::label('name', __('Name'), ['class' => 'col-form-label']) }}
            {{ Form::text('name', $booking_request->customer_name, ['class' => 'form-control', 'placeholder' => __('Enter Name'), 'required' => 'required']) }}
        </div>
        <div class="form-group col-12">
            {{ Form::label('email', __('Email'), ['class' => 'col-form-label']) }}
            {{ Form::email('email', $booking_request->customer_email, ['class' => 'form-control', 'placeholder' => __('Enter Email'), 'required' => 'required']) }}
        </div>
        <div class="form-group col-12">
            {{ Form::label('paasword', __('Paasword'), ['class' => 'col-form-label']) }}
