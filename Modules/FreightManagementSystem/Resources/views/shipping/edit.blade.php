    ...
    <div class="row">
                ...
                <div class="row ms-1">
                    <div class="form-check col-md-6">
                        <input class="form-check-input" type="radio" name="direction"
                            value="import" id="import" {{($shipping->direction == 'import') ? 'checked' :'' }}>
                    ...
                    <div class="form-check col-md-6">
                        <input class="form-check-input" type="radio" name="direction"
                            value="export" id="export" {{($shipping->direction == 'export') ? 'checked' :'' }}>
                ...
                <div class="row ms-1">
                    <div class="form-check col-md-4">
                        <input class="form-check-input" type="radio" name="transport"
                            value="air" id="air" {{($shipping->transport == 'air') ? 'checked' :'' }}>
                    ...
                    <div class="form-check col-md-4">
                        <input class="form-check-input" type="radio" name="transport"
                            value="ocean" id="ocean" {{($shipping->transport == 'ocean') ? 'checked' :'' }}>
                    ...
                    <div class="form-check col-md-4">
                        <input class="form-check-input" type="radio" name="transport"
                            value="land" id="land" {{($shipping->transport == 'land') ? 'checked' :'' }}>
        ...
        <div class="form-group col-6">
            ...
            <div class="choose-files ">
                ...
                <img id="blah"  width="25%" src="{{ !empty($shipping->attechment) ? get_file($shipping->attechment):'' }}" />
            </div>
        </div>
    </div>
</div>
