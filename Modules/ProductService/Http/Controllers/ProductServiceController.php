...
class ProductServiceController extends Controller
{
    ...
    public function create(Request $request)
    {
        if(Auth::user()->isAbleTo('product&service create'))
        {
            ...
            return view('productservice::create', compact('category', 'unit', 'tax','customFields','product_type','warehouse', 'workorder_id', 'components_id', 'pms_id', 'supplier_id'));
        }
        else
        {
    ...
    public function edit($id)
    {
        if(Auth::user()->isAbleTo('product&service edit'))
        {
            ...
            return view('productservice::edit', compact('category', 'unit', 'tax', 'productService','customFields','warehouse'));
        }
        else
        {
            return response()->json(['error' => __('Permission denied.')], 401);
