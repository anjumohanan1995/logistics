<div class="card" id="pos-sidenav">
    <?php echo e(Form::open(['route' => 'pos.setting.store'])); ?>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="low_product_stock_threshold"
                        class="form-label"><?php echo e(__('Low Product Stock Threshold')); ?></label>
                    <input type="number" name="low_product_stock_threshold" class="form-control"
                        placeholder="<?php echo e(__('Low Product Stock Threshold')); ?>"
                        value="<?php echo e(!empty($settings['low_product_stock_threshold']) ? $settings['low_product_stock_threshold'] : ''); ?>"
...
<div id="pos-print-sidenav" class="card">
    ...
    <div class="bg-none">
        <div class="row company-setting">
            <form id="setting-form" method="post" action="<?php echo e(route('pos.template.setting')); ?>"
                enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row ms-2">
                    <div class="col-md-3">
                        <div class="form-group">
                            <?php echo e(Form::label('pos_prefix', __('Prefix'), ['class' => 'form-label'])); ?>

                            <?php echo e(Form::text('pos_prefix', isset($settings['pos_prefix']) && !empty($settings['pos_prefix']) ? $settings['pos_prefix'] : '#PUR', ['class' => 'form-control', 'placeholder' => 'Enter Pos Prefix'])); ?>

                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <?php echo e(Form::label('pos_footer_title', __('Footer Title'), ['class' => 'form-label'])); ?>

                            <?php echo e(Form::text('pos_footer_title', isset($settings['pos_footer_title']) && !empty($settings['pos_footer_title']) ? $settings['pos_footer_title'] : '', ['class' => 'form-control', 'placeholder' => 'Enter Footer Title'])); ?>

                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <?php echo e(Form::label('pos_footer_notes', __('Footer Notes'), ['class' => 'form-label'])); ?>

                            <?php echo e(Form::textarea('pos_footer_notes', isset($settings['pos_footer_notes']) && !empty($settings['pos_footer_notes']) ? $settings['pos_footer_notes'] : '', ['class' => 'form-control', 'rows' => '1', 'placeholder' => 'Enter Pos Footer Notes'])); ?>

                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group mt-2">
                            <?php echo e(Form::label('pos_shipping_display', __('Shipping Display?'), ['class' => 'form-label'])); ?>
                            ...
                            <div class=" form-switch form-switch-left">
                                <input type="checkbox" class="form-check-input" name="pos_shipping_display"
                                    ...
                                    <?php echo e(isset($settings['pos_shipping_display']) && $settings['pos_shipping_display'] == 'on' ? 'checked' : ''); ?>>
                ...
                <div class="row">
                                ...
                                <select class="form-control" name="pos_template">
                                    <?php $__currentLoopData = \Modules\Pos\Entities\Pos::templateData()['templates']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($key); ?>"
                                            <?php echo e(isset($settings['pos_template']) && !empty($settings['pos_template']) && $settings['pos_template'] == $key ? 'selected' : ''); ?>>
                                    ...
                                    <?php $__currentLoopData = \Modules\Pos\Entities\Pos::templateData()['colors']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="pos_color" type="radio" value="<?php echo e($color); ?>"
                                                    class="colorinput-input"
                                                    <?php echo e(!empty($settings['pos_color']) && $settings['pos_color'] == $color ? 'checked' : ''); ?>>
                    ...
                    <div class="col-md-8">
                        <?php if(isset($settings['pos_template']) &&
...
<?php /**PATH /opt/lampp/htdocs/logistics/Modules/Pos/Resources/views/company/settings/index.blade.php ENDPATH**/ ?>