                                                    ...
                                                    <tbody>
                                                     ...
                                                     <?php $__currentLoopData = $module_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo e(Form::label('module_checkbox_'.$key.'_'.$list,  str_replace('_', ' ', $list), ['class' => 'form-check-label pointer'])); ?></td>
...
<?php /**PATH /opt/lampp/htdocs/logistics/resources/views/role/create.blade.php ENDPATH**/ ?>