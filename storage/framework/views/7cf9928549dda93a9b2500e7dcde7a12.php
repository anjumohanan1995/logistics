<header
    class="dash-header transprent-bg <?php echo e(empty($company_settings['site_transparent']) || $company_settings['site_transparent'] == 'on' ? 'transprent-bg' : ''); ?> ">
...
<?php /**PATH /opt/lampp/htdocs/logistics/resources/views/partials/header.blade.php ENDPATH**/ ?>