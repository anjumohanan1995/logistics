                ...
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-4 text-center">
                            <h6 ><?php echo e(__('Total Workspace')); ?></h6>
                        ...
                        <div class="col-4 text-center">
                            <h6 ><?php echo e(__('Active Workspace')); ?></h6>
                            <p class=" text-sm mb-0">
                                <i
                        ...
                        <div class="col-4 text-center">
                            <h6 ><?php echo e(__('Disable Workspace')); ?></h6>
                            <p class=" text-sm mb-0">
                                <i
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        ?>
                            <div class="tab-pane text-capitalize fade show <?php echo e($loop->index == 0 ? 'active' : ''); ?>"
                                ...
                                <?php if(module_is_active('LMS')): ?>
                                    <div class="row my-2 " data-workspace-id =<?php echo e($workspace->id); ?>>
                                        <?php
                                            $stores = \Modules\LMS\Entities\Store::where('workspace_id', $workspace->id)->first();
                                        ?>
                                        <div class="col-md-6 my-2">
                                            <div class="mb-3 mb-sm-0 list_colume_notifi">
                                                <h4><?php echo e(__('Store Details :')); ?></h4>
                                                <span><label for=""><?php echo e(isset($stores) ? $stores->name : ''); ?></label></span>
                                            </div>
                                        </div>
                                    </div>
                                <?php endif; ?>
...
<?php /**PATH /opt/lampp/htdocs/logistics/resources/views/users/companyinfo.blade.php ENDPATH**/ ?>