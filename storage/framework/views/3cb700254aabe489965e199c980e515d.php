                    ...
                    <tr>
                        ...
                        <td colspan="2" class="sub-total">
                            <table class="total-table">
                                ...
                                <tr>
                                    <td><?php echo e(__('Debit note issued')); ?>:</td>
                    ...
                    <?php if(isset($bank_details_list) && count($bank_details_list) > 0): ?>
                        <?php $__currentLoopData = $bank_details_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e(!empty($bank->opening_balance) ? currency_format_with_sym($bank->opening_balance, $invoice->created_by, $invoice->workspace) : ''); ?></td>
...
<?php /**PATH /opt/lampp/htdocs/logistics/resources/views/invoice/templates/template1.blade.php ENDPATH**/ ?>