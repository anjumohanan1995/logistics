...
<head>
    ...
    <meta name="title" content="<?php echo e(!empty($settings['meta_title']) ? $settings['meta_title'] : 'WOrkdo Dash'); ?>">
    <meta name="keywords" content="<?php echo e(!empty($settings['meta_keywords']) ? $settings['meta_keywords'] : 'WorkDo Dash,SaaS solution,Multi-workspace'); ?>">
    <meta name="description" content="<?php echo e(!empty($settings['meta_description']) ? $settings['meta_description'] : 'Discover the efficiency of Dash, a user-friendly web application by Rajodiya Apps.'); ?>">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo e(env('APP_URL')); ?>">
    <meta property="og:title" content="<?php echo e(!empty($settings['meta_title']) ? $settings['meta_title'] : 'WOrkdo Dash'); ?>">
    <meta property="og:description" content="<?php echo e(!empty($settings['meta_description']) ? $settings['meta_description'] : 'Discover the efficiency of Dash, a user-friendly web application by Rajodiya Apps.'); ?> ">
    <meta property="og:image" content="<?php echo e(get_file( (!empty($settings['meta_image'])) ? (check_file($settings['meta_image'])) ?  $settings['meta_image'] : 'uploads/meta/meta_image.png' : 'uploads/meta/meta_image.png'  )); ?><?php echo e('?'.time()); ?>">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="<?php echo e(env('APP_URL')); ?>">
    <meta property="twitter:title" content="<?php echo e(!empty($settings['meta_title']) ? $settings['meta_title'] : 'WOrkdo Dash'); ?>">
    <meta property="twitter:description" content="<?php echo e(!empty($settings['meta_description']) ? $settings['meta_description'] : 'Discover the efficiency of Dash, a user-friendly web application by Rajodiya Apps.'); ?> ">
    <meta property="twitter:image" content="<?php echo e(get_file( (!empty($settings['meta_image'])) ? (check_file($settings['meta_image'])) ?  $settings['meta_image'] : 'uploads/meta/meta_image.png' : 'uploads/meta/meta_image.png'  )); ?><?php echo e('?'.time()); ?>">
    ...
    <link rel="icon" href="<?php echo e((!empty($settings['favicon']) && check_file($settings['favicon'])) ? get_file($settings['favicon']) : get_file('uploads/logo/favicon.png')); ?><?php echo e('?'.time()); ?>" type="image/x-icon" />
    ...
    <link href="https://fonts.googleapis.com/css2?family=Overpass,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800&display=swap" rel="stylesheet">
        ...
        <?php if(isset($settings['body_fontfamily'])): ?>
            <?php
                $body_fontfamily = $settings['body_fontfamily'];
            ?>
            <style>
                :root {
                    --first-font: '<?php echo e($body_fontfamily); ?> , sans-serif ' !important ;
                }
            </style>
        <?php endif; ?>
    ...
    <?php else: ?>
        <link rel="stylesheet" href="<?php echo e(asset('market_assets/css/main-style1.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('market_assets/css/responsive1.css')); ?>">
    <?php endif; ?>
    ...
    <link rel="apple-touch-icon"
        href="<?php echo e((!empty(admin_setting('favicon')) && check_file(admin_setting('favicon'))) ? get_file(admin_setting('favicon')) : get_file('uploads/logo/favicon.png')); ?>" />

    <?php if(isset($settings['is_pwa_store_active'])  && $settings['is_pwa_store_active'] == 'on'): ?>
        <link rel="manifest" href="<?php echo e(asset('uploads/customer_app/manifest.json')); ?>" />
    <?php endif; ?>
    <?php
        $pwa = \Modules\LandingPage\Entities\LandingPageSetting::pwa_store();
    ?>
    <?php if(!empty($settings['theme_color'])): ?>
        <meta name="theme-color" content="<?php echo e($pwa->theme_color); ?>" />
    <?php endif; ?>
    <?php if(!empty($settings['background_color'])): ?>
        <meta name="apple-mobile-web-app-status-bar"
            content="<?php echo e(isset($pwa->background_color) ? $pwa->background_color : ''); ?>" />
    <?php endif; ?>
    ...
    <style>
        <?php echo isset($settings['landingpage_custom_css']) ? $settings['landingpage_custom_css'] : ''; ?>

    </style>

</head>

<body class="<?php echo e(!empty($themeColor)?$themeColor:'theme-1'); ?>" >

    <!-- header start here -->
    <header class="site-header header-style-one">
        <?php if($settings['is_top_bar_active'] == 'on'): ?>
    ...
    <div class="home-wrapper">
        <?php $__currentLoopData = json_decode( $settings['landing_page_section_sequence'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <!-- [ Banner ] start -->
            <?php if($settings['is_banner_section_active'] == 'on' && $value == 'is_banner_section_active'): ?>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="banner-content">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <a href="<?php echo e($settings['home_live_demo_link']); ?>" class="link-btn"><?php echo e($settings['home_link_button_text']); ?> <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="exclusive-partners">
                        <div class="container">
                            ...
                            <div class="partners-logo-slider">
                                <?php if(explode(',', $settings['home_logo']) && count(explode(',', $settings['home_logo'])) > 1 ): ?>
                                    ...
                                    <div class="logo-item">
                                        <a href="#">
                                            <img src="<?php echo e(check_file($logo_path.$home_logo) ? get_file($logo_path.$home_logo) : $old_path."/logo-dark.png"); ?>" alt="exclusive partner">
                                        </a>
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php else: ?>
                                    <?php for($i = 1; $i < 15; $i++): ?>
                                        <div class="logo-item">
                                            <a href="#">
                                                <img src="<?php echo e(check_file($logo_path.$settings['home_logo']) ? get_file($logo_path.$settings['home_logo']) : $old_path."/logo-dark.png"); ?>" alt="exclusive partner">
                                            </a>
                                        </div>
                                    <?php endfor; ?>
                                <?php endif; ?>
            ...
            <?php if($settings['is_features_section_active'] == 'on' && $value == 'is_features_section_active'): ?>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12 support-card">
                                        <div class="support-card-inner">
                                            ...
                                            <div class="support-content-bottom">
                                                <a href="<?php echo e($value['feature_more_details_link']); ?>" class="btn"><?php echo $value['feature_more_details_button_text']; ?> <svg xmlns="http://www.w3.org/2000/svg" width="16"
            ...
            <?php if($settings['is_reviews_section_active'] == 'on' && $value == 'is_reviews_section_active'): ?>
            ...
            <!-- [ Screenshots ] start -->
            <?php if($settings['is_screenshots_section_active'] == 'on' && $value == 'is_screenshots_section_active'): ?>
            ...
            <!-- [ dedicated ] start -->
            <?php if($settings['is_dedicated_section_active'] == 'on' && $value == 'is_dedicated_section_active'): ?>
                                ...
                                <?php $__currentLoopData = json_decode($settings['dedicated_card_details'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12 information-card">
                                        <div class="information-card-inner">
                                            <div class="card-icon">
                                                    <img src="<?php echo e(check_file($value['dedicated_card_logo']) ? get_file($value['dedicated_card_logo']) : '#'); ?>" alt="">
                                            </div>
            ...
            <?php if($settings['is_buildtech_section_active'] == 'on' && $value == 'is_buildtech_section_active'): ?>
                            ...
                            <?php if(is_array(json_decode($settings['buildtech_card_details'], true)) || is_object(json_decode($settings['buildtech_card_details'], true))): ?>
                                <?php $__currentLoopData = json_decode($settings['buildtech_card_details'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 information-card">
                                        <div class="information-card-inner">
                                            <div class="card-icon">
                                                <img src="<?php echo e(check_file($value['buildtech_card_logo']) ?  get_file($value['buildtech_card_logo']) : '#'); ?>" alt="">
                                            </div>
                                            <div class="information-content">
            ...
            <?php if($settings['is_package_details_section_active'] == 'on' && $value == 'is_package_details_section_active'): ?>
        ...
        <footer class="site-footer">
            <div class="container">
                ...
                <div class="footer-row">
                    ...
                    <?php endif; ?>
                    <!-- Footer section start here -->
                    <?php if( isset($settings['is_newsletter_enabled']) && $settings['is_newsletter_enabled'] == 'on'): ?>
    ...
    <script>
         <?php echo e(isset($settings['landingpage_custom_js']) ? $settings['landingpage_custom_js'] : ''); ?>

    </script>

    <?php $__currentLoopData = \Modules\LandingPage\Entities\Pixel::getPixelScript(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $script): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?= $script ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</body>
<?php /**PATH /opt/lampp/htdocs/logistics/Modules/LandingPage/Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>