...
unset($__errorArgs, $__bag); ?>
 ...
 <div class="card" id="chat-gpt-setting-sidenav">
     ...
     <div class="card-body">
         <div class="row mt-2">
             ...
             <div class="form-group">
                 <?php echo e(Form::label('chatgpt_model', __('Chatgpt Model'), ['class' => 'col-form-label'])); ?>

                 <?php echo e(Form::text('chatgpt_model', isset($settings['chatgpt_model']) ? $settings['chatgpt_model'] : '', ['class' => 'form-control', 'placeholder' => 'Enter Chatgpt Model name'])); ?>
 ...
 ?>
 <?php if(in_array('AIAssistant', $activatedModules) ||
         in_array('AIDocument', $activatedModules) ||
         in_array('AIImage', $activatedModules)): ?>
     <script>
         $(document).ready(function() {
 ...
 <?php endif; ?>
<?php /**PATH /opt/lampp/htdocs/logistics/resources/views/super-admin/settings/index.blade.php ENDPATH**/ ?>