    ...
    <div class="card-header">
        <div class="row">
            <div class="col-lg-10 col-md-10 col-sm-10">
                ...
                <small><?php echo e(__('These details will be used to collect subscription, invoice, retainer, etc. payments.')); ?></small>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea type="text" name="bank_number" id="bank_number" class="form-control bank_transfer_text" <?php echo e((isset($settings['bank_transfer_payment_is_on']) && $settings['bank_transfer_payment_is_on']  == 'on') ? '' : ' disabled'); ?> rows="3" placeholder="<?php echo e(__('Bank Transfer Number')); ?>"><?php echo e(!empty(company_setting('bank_number'))?company_setting('bank_number'):''); ?></textarea>
...
<?php /**PATH /opt/lampp/htdocs/logistics/resources/views/bank_transfer/setting.blade.php ENDPATH**/ ?>