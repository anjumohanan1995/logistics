    ...
    <div>
        ...
        <?php if((module_is_active('ProductService') && module_is_active('Account')) || module_is_active('Taskly')): ?>
            <?php if (app('laratrust')->hasPermission('invoice manage')) : ?>
                <a href="<?php echo e(route('invoice.grid.view')); ?>"  data-bs-toggle="tooltip" data-bs-original-title="<?php echo e(__('Grid View')); ?>" class="btn btn-sm btn-primary btn-icon">
                    <i class="ti ti-layout-grid"></i>
                </a>
                <a href="<?php echo e(route('invoice.status.view')); ?>"  data-bs-toggle="tooltip" data-bs-original-title="<?php echo e(__('Quick Stats')); ?>" class="btn btn-sm btn-primary btn-icon">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row d-flex align-items-center justify-content-end">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12 col-12">
                            <div class="btn-box">
                                <?php echo e(Form::label('account_type', __('Account Type'), ['class' => 'form-label'])); ?>
                        ...
                        <table class="table mb-0 pc-dt-simple" id="assets">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="Id">
                                            <?php if(Laratrust::hasPermission('invoice show')): ?>
                                                <a href="<?php echo e(route('invoice.show', \Crypt::encrypt($invoice->id))); ?>"
                                                    class="btn btn-outline-primary"><?php echo e(App\Models\Invoice::invoiceNumberFormat($invoice->invoice_id)); ?></a>
                                            <?php else: ?>
                                                <a href="#"
                                                    class="btn btn-outline-primary"><?php echo e(App\Models\Invoice::invoiceNumberFormat($invoice->invoice_id)); ?></a>
                                            <?php endif; ?>
                                        ...
                                        <td><?php echo e($invoice->account_type == 'Taskly' ? 'Project': preg_replace('/([a-z])([A-Z])/', '$1 $2', $invoice->account_type)); ?></td>
                                        <td><?php echo e(company_date_formate($invoice->issue_date)); ?></td>
                                        <td>
                                            <?php if($invoice->due_date < date('Y-m-d')): ?>
                                                <p class="text-danger">
                                                    <?php echo e(company_date_formate($invoice->due_date)); ?></p>
                                            <?php else: ?>
                                        ...
                                        <?php if($invoice->invoice_module == 'childcare'): ?>
                                            ...
                                            <td><?php echo e(currency_format_with_sym($invoice->getChildTotal())); ?></td>
                                        <?php else: ?>
                                        ...
                                        <?php if($invoice->invoice_module == 'childcare'): ?>
                                            ...
                                            <td><?php echo e(currency_format_with_sym($invoice->getChildDue())); ?></td>
                                        <?php else: ?>
                                            <td><?php echo e(currency_format_with_sym($invoice->getDue())); ?></td>
                                        <?php endif; ?>
                                            ...
                                            <td class="Action">
                                                <span>
                                                    <div class="action-btn bg-primary ms-2">
                                                        <a href="#" class="btn btn-sm  align-items-center cp_link" data-link="<?php echo e(route('pay.invoice',\Illuminate\Support\Facades\Crypt::encrypt($invoice->id))); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Copy')); ?>" data-original-title="<?php echo e(__('Click to copy invoice link')); ?>">
                                                    ...
                                                    <div class="action-btn bg-info ms-2">
                                                        <a href="#" class="btn btn-sm  align-items-center" data-url="<?php echo e(route('delivery-form.pdf',\Crypt::encrypt($invoice->id))); ?>" data-ajax-popup="true" data-size="lg" data-bs-toggle="tooltip" title="<?php echo e(__('Invoice Delivery Form')); ?>" data-title="<?php echo e(__('Invoice Delivery Form')); ?>">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/logistics/resources/views/invoice/index.blade.php ENDPATH**/ ?>