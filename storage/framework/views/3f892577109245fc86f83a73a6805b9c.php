<?php
    ...
    <?php $__env->startPush('scripts'); ?>
        <script src="<?php echo e(asset('Modules/LandingPage/Resources/assets/js/jquery.qrcode.js')); ?>"></script>
        <script src="<?php echo e(asset('Modules/LandingPage/Resources/assets/js/jquery.qrcode.min.js')); ?>"></script>
        <script src="<?php echo e(asset('Modules/LandingPage/Resources/assets/js/socialSharing.js')); ?>"></script>
        <script src="<?php echo e(asset('Modules/LandingPage/Resources/assets/js/socialSharing.min.js')); ?>"></script>
    ...
    <?php $__env->stopPush(); ?><?php /**PATH /opt/lampp/htdocs/logistics/Modules/LandingPage/Resources/views/layouts/dash_qr_scripts.blade.php ENDPATH**/ ?>