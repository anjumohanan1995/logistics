    ...
    <div>
        ...
        <?php if((module_is_active('ProductService') && module_is_active('Account')) || module_is_active('Taskly')): ?>
            <?php if (app('laratrust')->hasPermission('proposal manage')) : ?>
                ...
                <a href="<?php echo e(route('proposal.stats.view')); ?>"  data-bs-toggle="tooltip" data-bs-original-title="<?php echo e(__('Quick Stats')); ?>" class="btn btn-sm btn-primary btn-icon">
                        ...
                        <table class="table mb-0 pc-dt-simple" id="assets">
                            ...
                            <tbody>
                                ...
                                <tr class="font-style">
                                        ...
                                        <?php endif; ?>
                                        <td><?php echo e($proposal->account_type); ?></td>
                                        ...
                                        <td>
                                            ...
                                            <td class="Action">
                                                <span>
                                                    ...
                                                    <?php endif; // app('laratrust')->permission ?>
                                                    <?php if(module_is_active('ProductService') && ($proposal->proposal_module == 'taskly' ? module_is_active('Taskly') : module_is_active('Account')) && ($proposal->proposal_module == 'cmms' ? module_is_active('CMMS') : module_is_active('Account'))): ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/logistics/resources/views/proposal/index.blade.php ENDPATH**/ ?>