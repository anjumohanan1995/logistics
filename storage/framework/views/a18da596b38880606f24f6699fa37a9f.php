        ...
        <li class="dropdown dash-h-item drp-language">
            ...
            <div class="dropdown-menu dash-h-dropdown dropdown-menu-end">
                <?php $__currentLoopData = languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('verification.notice', $key)); ?>"
    ...
    <div class="card">
        <div class="card-body">
            <div class="">
                ...
                <h6><?php echo e(__('Thanks for signing up! Before getting started, could you verify your email address by clicking on the link we just emailed to you? If you didn\'t receive the email, we will gladly send you another.')); ?>
            ...
            <form method="POST" action="<?php echo e(route('verification.send')); ?>">
                ...
                <div class="d-grid">
                    <button type="submit" class="btn btn-primary btn-block mt-2"
                        tabindex="4"><?php echo e(__('Resend Verification Email')); ?></button>
                </div>
            </form>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/logistics/resources/views/auth/verify-email.blade.php ENDPATH**/ ?>