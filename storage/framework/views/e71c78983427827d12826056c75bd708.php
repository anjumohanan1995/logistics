            ...
            <?php if(Auth::user()->type != 'super admin'): ?>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <?php echo e(Form::text('mobile_no',null,array('class'=>'form-control','placeholder'=>__('Enter User Mobile No')))); ?>
...
<?php /**PATH /opt/lampp/htdocs/logistics/resources/views/users/create.blade.php ENDPATH**/ ?>