...
class InvoiceController extends Controller
{
      ...
      //  dd($customerId);
        if (module_is_active('ProductService')) {
            if (Auth::user()->isAbleTo('invoice create')) {
                ...
                return view('invoice.create', compact('customers', 'invoice_number', 'projects', 'taxs', 'category', 'customerId', 'customFields', 'work_order', 'rent_type', 'students', 'sale_invoice', 'inspectionRequests', 'machineRequests', 'music_students'));
            } else {
                return redirect()->back()->with('error', __('Permission denied.'));
            }
        } else {
    ...
    public function invoice($invoice_id)
    {
        ...
        if ($invoice) {
            ...
            return view('invoice.templates.' . $invoice_template, compact('invoice', 'color', 'settings', 'customer', 'img', 'font_color', 'customFields', 'bank_details', 'bank_details_list'));
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
    }
